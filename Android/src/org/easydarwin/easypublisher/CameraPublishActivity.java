...
public class CameraPublishActivity extends Activity implements Callback, PreviewCallback 
{
	...
	private int maxResolusion;
	
	private int bResFlag = 0;
    ...
    class ButtonResolutionListener implements OnClickListener
    {
        public void onClick(View v)
        {    
        	Log.i(TAG, "onClick Resolution change..bResFlag：" + bResFlag);
        	...
        	if(bResFlag == 0)
        	{
        		...
        		textCurResolution.setText("当前分辨率：中[320*240]");	
        	}
        	else if(bResFlag == 1)
        	{
        		videoWidth = 176;
        		...
        		textCurResolution.setText("当前分辨率：低[176*144]");
        	}else if(bResFlag == 2)
        	{
        		videoWidth = 1280;
            	videoHight = 720;
        		...
        		bResFlag = 3;
        		textCurResolution.setText("当前分辨率：超高[1280*720]");
        	}else if(bResFlag == 3)
        	{
        		videoWidth = 640;
        		videoHight = 480;
        		...
        		bResFlag = 0;
        		textCurResolution.setText("当前分辨率：高[640*480]");
        	}
